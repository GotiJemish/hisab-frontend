...
const icons = {
  ...
  error: {
    color: "fill-error-600 dark:fill-error-500",
    path: (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
  ...
  warning: {
    color: "fill-warning-600 dark:fill-orange-400",
    path: (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
  ...
  info: {
    color: "fill-blue-light-500 dark:fill-blue-light-500",
    path: (
      <path
        fillRule="evenodd"
        clipRule="evenodd"
    ...
    >
      <div className="text-center">
        <div className="relative flex items-center justify-center z-1 mb-7">
          <svg
            className={bgColors[variant] || bgColors.error}
            width={80}
            height={80}
            viewBox="0 0 90 90"
            fill="none"
        ...
        <div className="flex items-center justify-center w-full gap-3 mt-7">
          <Button
            variant={variant}
            className="flex justify-center w-full px-4 py-3 text-sm font-medium rounded-lg sm:w-auto"
            title="Okay, Got It"
            onClick={onConfirm}
          />
        </div>
