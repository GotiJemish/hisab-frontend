              ...
              <div>
                ...
                <div className="relative z-20 bg-transparent">
                  <select
                    ...
                    //   :className="isOptionSelected &amp;&amp; 'text-gray-800 dark:text-white/90'"
            ...
            <form>
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3 lg:grid-cols-12">
                ...
                <div className="w-full lg:col-span-2">
                  ...
                  <select className="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-white px-4 py-2.5 pr-11 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30">
